  ...
  <div class="container-fluid dashboard">
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="card">
          <div class="px-4">
              <a href="{{ route('create-designation') }}" class='btn btn-block btn-xl btn-primary font-bold mt-3'>Create Designation</a>
            </div>
        </div>
      </div>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{route('edit-designation', $row->id)}}" class="btn btn-primary btn-sm">Edit</button>
                        <a href="{{route('delete-designation', $row->id)}}" class="btn btn-warning btn-sm">Hapus</button>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
